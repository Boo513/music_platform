  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <div className="flex items-center gap-3 px-6 py-4">
        ...
        <button
          className="w-10 h-10 min-w-[40px] rounded-full bg-gradient-to-br from-[#FF8C42] to-[#FFB366] flex items-center justify-center
      ...
      <div className="flex items-center gap-2 px-6 mb-5 overflow-x-auto pb-1">
        <span className="text-[#a09080] text-xs mr-1 flex-shrink-0">风格</span>
        <button
          className={`px-3 py-1.5 rounded-2xl text-[11px] whitespace-nowrap transition-all border cursor-pointer
            ${!styleFilter
              ? 'text-[#FFB366] font-semibold border-[rgba(255,179,102,0.2)]'
              : 'text-[#a09080] border-transparent hover:text-[#ffe0c8]'}`}
      ...
      {loading ? (
        <div className="flex items-center justify-center py-20 text-[#a09080] text-sm">加载中...</div>
      ) : songs.length > 0 ? (
