...
export default function ProfilePage() {
 ...
 border-[3px] border-orange-20 
 flex items-center justify-center text-4xl">🌌</div>
 <div className="absolute -bottom-0.5 -right-0.5 w-22 h-22 rounded-full 
 border-2 border-[#0a0a18] flex items-center justify-center text-10 text-white cursor-pointer">✎</div>
 </div>
 ...
 {tabs.map((t) => (
 <button key={t.key}
 className={`px-5 py-3 text-13 font-semibold transition-all border-b-2
 ${tab === t.key ? ' border-orange-20' : ' border-transparent'}`}
