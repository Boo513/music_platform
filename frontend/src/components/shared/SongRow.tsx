...
export function SongRow({ song, onClick, extra }: SongRowProps) {
  ...
  return (
    <div
      className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[rgba(255,255,255,0.02)] border border-white/4
        hover:bg-[rgba(255,255,255,0.04)] cursor-pointer transition-all duration-200"
