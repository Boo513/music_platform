  ...
  const btn = (text: string, onClick: () => void) => (
    <button
      className="w-[34px] h-[34px] rounded-full flex items-center justify-center cursor-pointer
        ...
        bg-[rgba(20,16,28,0.4)] backdrop-blur-[10px] border border-[rgba(255,255,255,0.06)]
        hover:bg-[rgba(40,30,50,0.55)] hover:border-[rgba(255,255,255,0.15)] hover:text-[#ffe0c8]"
      onClick={onClick}
    >{text}</button>
  );
