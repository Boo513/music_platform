  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50
        glass-panel p-6 w-80 duration-200">
        ...
        <input
          className="w-full px-3.5 py-3 rounded-xl bg-white/5 border border-white/10 text-sm text-white placeholder:text-white/25 outline-none focus:border-purple-400/40 transition-colors"
          value={nickname}
        ...
        <div className="flex gap-3 mt-6">
          ...
          <div className="flex-1">
            <NeonButton onClick={() => { onSave(nickname); onClose(); }}>保存</NeonButton>
          </div>
        </div>
      </div>
    </>
