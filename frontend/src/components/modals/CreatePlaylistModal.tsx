...
export function CreatePlaylistModal({ open, onClose, onCreate }: Props) {
 ...
 <label className=" text-11 uppercase tracking-wider mb-1.5 block">歌单名称 *</label>
 ...
 <label className=" text-11 uppercase tracking-wider mb-1.5 block">描述</label>
 ...
 <span className=" text-13">公开</span>
 <button
